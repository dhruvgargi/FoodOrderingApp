...
public class RestaurantControllerTest {
    ...
    public void shouldGetRestaurantDetailsForCorrectRestaurantId() throws Exception {
        ...
        when(mockRestaurantService.getRestaurantByCategoryId("someRestaurantId"))
        ...
        verify(mockRestaurantService, times(1)).getRestaurantByCategoryId("someRestaurantId");
    ...
    public void shouldUpdateRestaurantRating() throws Exception {
        ...
        final RestaurantEntity restaurantEntity = getRestaurantEntity();
        when(mockRestaurantService.getRestaurantByCategoryId(restaurantId)).thenReturn(restaurantEntity);
        ...
        verify(mockRestaurantService, times(1)).getRestaurantByCategoryId(restaurantId);
    ...
    public void shouldNotUpdateRestaurantRatingIfCustomerIsNotLoggedIn() throws Exception {
        ...
        verify(mockRestaurantService, times(0)).getRestaurantByCategoryId(anyString());
    ...
    public void shouldNotUpdateRestaurantRatingIfRestaurantDoesNotExists() throws Exception {
        ...
        when(mockRestaurantService.getRestaurantByCategoryId(restaurantId))
                .thenThrow(new RestaurantNotFoundException("RNF-001", "No restaurant by this id"));
